...
## 🚀 How to Use
1. **Open Script Editor:** Find "Script Editor" in your Mac's Applications or via Spotlight.
2. **Copy the Code:** Copy the contents of `twoFinderWindows.applescript` from this repo.
3. **Paste & Run:** Paste the code into Script Editor and press the **Play (Run)** button.

**Note:** Because this script uses "System Events" to simulate keystrokes, your Mac may ask for permission to allow Script Editor (or your exported App) to control your computer. You can grant this in *System Settings > Privacy & Security > Accessibility*.
